    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="card bg-danger/5 border border-danger/30 mt-8">
        ...
        <ul className="text-sm text-muted space-y-2">
          ...
          <li><strong>This is not legal advice.</strong> AutoAppeal provides administrative assistance with citation paperwork. We are not a law firm and do not provide legal representation unless expressly stated in a separate agreement.</li>
