...
export default function FounderDashboard() {
  ...
  const controls = [
    ...
    { label: 'Founder Dashboard™',     key: 'founderDashboardActive' as const },
  ]
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <p className="text-xs text-[#27415e] mb-8">Founder authority supersedes all automation systems and deployment logic.</p>
