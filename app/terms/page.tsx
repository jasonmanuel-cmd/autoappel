...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://AppealMyTickets.com/terms' },
      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-8">
          {[
            ...
            { title: '4. Fees and Payment', content: 'Our service fee is a flat $79.99 per citation submission. Payment is due before services begin. All payments are processed securely through our payment provider. Fees are non-refundable once services have been rendered, unless otherwise specified. We do not offer tiered pricing or hidden fees.' },
