      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="space-y-8">
          ...
          <div className="card">
            ...
            <p className="text-muted">AutoAppeal™ is committed to protecting your privacy and ensuring you have a positive experience on our website and when using our services. This Privacy Policy outlines what information we collect, how we use it, and how we protect it.</p>
          </div>
          ...
          {[
            ...
            { title: '5. Information Sharing', content: 'We do not sell, trade, or rent your personal information to third parties. We may share your information only when:', list: ['Required by law or court order', 'Necessary to process your appeal with courts and legal authorities', 'With our trusted service providers who help us operate our website', 'You explicitly consent to the sharing'] },
            ...
            { title: '7f. How to Exercise Your Rights', content: 'To exercise any of the above rights, submit a request via email to privacy@autoappeal.com or through our contact page. We will respond within 45 days. If we deny your request, you may appeal by contacting us with the reason for the denial.' },
          ...
          <div className="card bg-primary/10 border-primary/30">
            ...
            <p className="text-muted">If you have questions about this Privacy Policy or our privacy practices, please contact us at{' '}
              <a href="mailto:privacy@autoappeal.com" className="text-primary hover:underline">privacy@autoappeal.com</a>
            </p>
          </div>
        </div>
      </div>
